...
export default function SettingsPage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      enqueueSnackbar('Đổi mật khẩu thành công, vui lòng đăng nhập lại', { variant: 'success' });
        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              <b>Hanne Store</b> — hệ thống quản lý kho & bán hàng chạy hoàn toàn trên máy của bạn. Dữ liệu được lưu cục bộ
              (SQLite), không gửi lên bất kỳ dịch vụ bên thứ ba nào.
            </Typography>
            <Alert severity="info" variant="outlined" sx={{ mt: 2, borderRadius: 2 }}>
              Mẹo: dùng nút <b>Chia sẻ</b> / <b>Lưu ảnh</b> ở màn hình hóa đơn để gửi bill cho khách qua Zalo, Messenger...
            </Alert>
          </CardContent>
        </Card>
      </Stack>
